...
const questions = {
    ...
    8: {
        ...
        options: [
            { text: 'Немного новостей еще никому не мешали, сейчас самое время!', isCorrect: false, advice: 'Привычка все свободное время проводить в телефоне — признак интернет-зависимости. Ты можешь зайти в ленту с мыслью посидеть пару минут, а в итоге наткнешься на что-нибудь интересное и проведешь за чтением гораздо больше, чем задумывал изначально. Кроме того, ты дополнительно потратишь время на обдумывание всего того, что только что прочитал. \
            ...
            { text: 'Включу видео или кино, так быстрее засыпается.', isCorrect: false, advice: 'Засыпание с гаджетами — это явный симптом интернет-зависимости. С огромной вероятностью засыпая под просмотром кино или захватывающего видео, ты не выспишься, под утро будешь чувствовать себя разбитым. Это происходит потому, что мерцание экрана и активные действия в кино или различных видео будоражат психику и не даёт мозгу отключиться. \
